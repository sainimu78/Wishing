...
namespace NiflectGen
{
	...
	private:
		...
		void ResolveRecurs4(CTaggedNode2* taggedParent, CResolvedData& data, CTaggedTypesMapping& resolvedMapping, CUntaggedTemplateTypesMapping& untaggedTemplateMapping);
