...
#define NIF_AS_Compound_1() using NIFLECTGENINTERNAL_COMBINE(__NiflectGen_AccessorSettingA,_,__LINE__) = 

//enum class 将绑定此设置指定的 Accessor
//此设置在模块范围内只可使用1次
//名称末尾的1表示 TSetting 模板需要指定的模板参数个数为1
#define NIF_AS_EnumClass_1() using NIFLECTGENINTERNAL_COMBINE(__NiflectGen_AccessorSettingB,_,__LINE__) = 

//enum 将绑定此设置指定的 Accessor
//此设置在模块范围内只可使用1次
//名称末尾的1表示 TSetting 模板需要指定的模板参数个数为1
#define NIF_AS_EnumBitsMask_1() using NIFLECTGENINTERNAL_COMBINE(__NiflectGen_AccessorSettingC,_,__LINE__) = 
...
#define NIF_AS_Binding_2_3() using NIFLECTGENINTERNAL_COMBINE(__NiflectGen_AccessorSettingD,_,__LINE__) = 
