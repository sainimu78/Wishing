...
public:
    ...
    __attribute__((noinline)) void movement_system() noexcept {
        const size_t size = positions.size();
        Position* __restrict pos = positions.data();
        const Velocity* __restrict vel = velocities.data();
