...
cmake ../../../../../../Project/Sample/$ProjectName -G "$option_visual_studio" $option_generator_toolset_Predefines -DCMAKE_BUILD_TYPE=Debug

cd $aaaaaaaaa
cd $OutputDirNameRelease
cmake ../../../../../../Project/Sample/$ProjectName -G "$option_visual_studio" $option_generator_toolset_Predefines -DCMAKE_BUILD_TYPE=Release
